...
function MarioGame() {
  ...
  audio.volume = 0.6; audio.currentTime = 0;
              }
            }, 3000);
            break;
          }
    ...
    for (var i = 0; i < goombas.length; i++) {
      for (var j = 0; j < bullets.length; j++) {
        ...
        if (collWithBullet) {
          ...
          var audio = new Audio('SE_OssanHimei4.wav');
          audio.play();
          var audio = new Audio('Mario_bullseye.wav');
          audio.play();
          var audio = new Audio('Yay.wav');
          audio.play();
          score.totalScore += 6600;
          score.lifeCount+= 6;
          score.updateTotalScore();
          score.updateLifeCount();
          //sound when enemy dies
  ...
  this.levelFinish = function(collisionDirection) {
    ...
    if (marioInGround) {
      ...
      if (tickCounter > maxTick) {
        ...
        audio.volume = 0.0; audio.currentTime = 0;    
         var audio = document.getElementById("myaudio");
        audio.volume = 0.0; audio.currentTime = 0;  var audio = document.getElementById("sm");
        audio.volume = 0.6; audio.currentTime = 0;
        timeOutId = setTimeout(function() {
          currentLevel++;
          if (originalMaps[currentLevel]) {
            ...
            setTimeout(function(){ window.location.replace("Did It!.html");}, 0000);
          }
        }, 9000);
      }
    }
  ...
  this.gameOver = function() {
    score.gameOverView();
    var audio = new Audio('sounds/smw_game_over.wav');
    audio.play();
